...
This app uses a read-only API key to fetch events from `https://openeventsapi.com/api/v1.0`

Learn more: [OpenEvents API Documentation](https://openeventsapi.com/docs)
